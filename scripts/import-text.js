...
import { buildTextEpisode, segmentsFromText } from "../backend/src/text-segments.js";
...
if (!args.episodeId || !args.title || !args.input) {
  console.error("Usage: node scripts/import-text.js --episodeId my-episode --title \"My Episode\" --input input.txt [--sourceUrl URL] [--level G5-G6]");
  process.exit(1);
}
